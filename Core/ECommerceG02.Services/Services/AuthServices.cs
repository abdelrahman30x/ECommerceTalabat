...
using ECommerceG02.Shared.DTOs.AuthDto_s;
...
namespace ECommerceG02.Services
{
    public class AuthServices : IAuthServices
    {
        ...
        public async Task<AddressDto> UpdateUserAddressAsync(string userId, AddressDto addressDto)
        {
            ...
            user.Address.IsActive = addressDto.IsActive ?? true;
            user.Address.IsDefault = addressDto.IsDefault ?? false;
            user.Address.CreatedAt = addressDto.CreatedAt ?? DateTime.UtcNow;
            user.Address.UpdatedAt = addressDto.UpdatedAt ?? DateTime.UtcNow;
